...
namespace GCWG06_HFT_2021221.Endpoint2
{
    public class Startup
    {
        ...
        {
            services.AddTransient<MedicalDbContext>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "GCWG06_HFT_2021221.Endpoint2", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "GCWG06_HFT_2021221.Endpoint2 v1"));
            }
